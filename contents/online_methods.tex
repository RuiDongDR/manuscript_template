...
\rmk{Technical Note: All simulations were implemented in \texttt{R v4.5} using \texttt{data.table} library. Code is available at \url{https://github.com/gaow/susieR}.}
